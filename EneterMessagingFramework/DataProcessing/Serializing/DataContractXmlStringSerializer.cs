...
namespace Eneter.Messaging.DataProcessing.Serializing
{
    ...
    public class DataContractXmlStringSerializer : ISerializer
    {
        ...
        /// is thread safe.
        /// </param>
        public DataContractXmlStringSerializer(Func<Type, DataContractSerializer> dataContractFactoryMethod)
        {
            ...
            using (EneterTrace.Entering())
            {
                ...
                try
                {
                    using (StringWriter aStringWriter = new StringWriter())
                    {
                        ...
                        {
                            DataContractSerializer xmlSerializer = myDataContractFactoryMethod(typeof(_T));
        ...
        private Func<Type, DataContractSerializer> myDataContractFactoryMethod;
