...
{
    internal class DuplexTypedSequencedMessageReceiver<_ResponseType, _RequestType> : AttachableDuplexInputChannelBase,
                                                                          IDuplexTypedSequencedMessageReceiver<_ResponseType, _RequestType>
    {
        ...
        public DuplexTypedSequencedMessageReceiver(ISerializer serializer)
        {
        ...
        public void SendResponseMessage(string responseReceiverId, _ResponseType responseMessage, string sequenceId, bool isSequenceCompleted)
        {
            using (EneterTrace.Entering())
            {
                ...
                try
                {
                    lock (myResponseSequences)
                    {
                        ...
                        AttachedDuplexInputChannel.SendResponseMessage(responseReceiverId, aSerializedResponseMessage);
