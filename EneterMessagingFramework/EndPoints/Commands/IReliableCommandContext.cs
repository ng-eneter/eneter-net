...
namespace Eneter.Messaging.EndPoints.Commands
{
    ...
    public interface IReliableCommandContext<_ReturnDataType, _InputDataType>
    {
        /// <summary>
        ...
        /// <returns>Id of the response message.</returns>
        string ResponseFailure(string errorMessage);
        ...
        /// <returns>Id of the response message.</returns>
        string Response(ECommandState commandState, _ReturnDataType returnData);
        ...
        /// <returns>Id of the response message.</returns>
        string Response(ECommandState commandState, _ReturnDataType returnData, string sequenceId, bool isReturnDataSequenceCompleted);
    }
}
