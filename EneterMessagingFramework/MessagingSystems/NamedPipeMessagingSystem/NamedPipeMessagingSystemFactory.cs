...
namespace Eneter.Messaging.MessagingSystems.NamedPipeMessagingSystem
{
    ...
    public class NamedPipeMessagingSystemFactory : IMessagingSystemFactory
    {
        ...
        public NamedPipeMessagingSystemFactory(int numberOfInputchannelListeningThreads, int pipeConnectionTimeout)
            : this(numberOfInputchannelListeningThreads, pipeConnectionTimeout, null)
        {
        }
        ...
        /// </param>
        public NamedPipeMessagingSystemFactory(int numberOfInputchannelListeningThreads, int pipeConnectionTimeout, PipeSecurity pipeSecurity)
        {
            using (EneterTrace.Entering())
            {
                myNumberOfInputchannelListeningThreads = numberOfInputchannelListeningThreads;
                myOutputChannelConnectionTimeOut = pipeConnectionTimeout;
        ...
        public IOutputChannel CreateOutputChannel(string channelId)
        {
            using (EneterTrace.Entering())
            {
                return new NamedPipeOutputChannel(channelId, myOutputChannelConnectionTimeOut);
            }
        }
        ...
        public IInputChannel CreateInputChannel(string channelId)
        {
            using (EneterTrace.Entering())
            {
                return new NamedPipeInputChannel(channelId, myNumberOfInputchannelListeningThreads, myPipeSecurity);
            }
        }
        ...
        public IDuplexOutputChannel CreateDuplexOutputChannel(string channelId)
        {
            using (EneterTrace.Entering())
            {
                ...
                return new SimpleDuplexOutputChannel(channelId, aResponseReceiverId, this);
            }
        }
        ...
        private int myNumberOfInputchannelListeningThreads;
        private int myOutputChannelConnectionTimeOut;
