    ...
    public class Reconnecter
    {
        ...
        private void DoReconnect()
        {
            using (EneterTrace.Entering())
            {
                ...
                {
                    Thread.Sleep((int)myReconnecFrequency.TotalMilliseconds);
        ...
        private string TracedObject
        {
            get
            {
                string aChannelId = (myDuplexOutputChannel != null) ? myDuplexOutputChannel.ChannelId : "";
                return GetType().Name + " '" + aChannelId + "' ";
            }
        }
    }
}
