...
namespace Eneter.Messaging.Diagnostic
{
    ...
    internal static class ErrorHandler
    {
        ...
        public const string ChannelNotAttached = "failed to send the request message because the output channel is not attached.";

        public const string SendResponseFailure = "failed to send the response message.";
        public const string SendResponseNotConnectedFailure = "cannot send the response message when client is not connected.";
        public const string SendResponseNotListeningFailure = "cannot send the response message when duplex input channel is not listening.";
