...
{
    /// <summary>
    /// Receiver which confirms if the message weas received.
    /// </summary>
    /// <remarks>
    /// It receives request messages of specified type and sends back response messages of specified type.
    /// Reliable means it provides events notifying whether the response message was delivered or not.
    /// ReliableTypedMessageReceiver can receive messages only from ReliableTypedMessageSender.
    /// </remarks>
