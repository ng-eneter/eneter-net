...
{
    public abstract class MonitorConnectionTesterBase : MessagingSystemBaseTester
    {
        public override void A09_OpenCloseConnection()
        {
            // This test-case is not applicable, because the output channel sends the ping and that will reconnect the connection.
        }

        public override void A15_DuplexOutputChannelConnected_CloseFromOpenHandler()
        {
            // This test-case is not applicable, because the output channel sends the ping and that will reconnect the connection.
        }
